...
>    
Sure, here is the Python function to put a pencil in a notebook and the notebook on a sofa:  
...
This function first ensures that the pencil and notebook are in the room. Then, it grabs the pencil and puts it in the notebook. Finally, it finds the sofa and puts the notebook on it.  
